...
const ElectronicsPage = () => {
    ...
    const getAPI = async () => {
        const url = "http://192.168.1.18:3000/electronics";
    ...
    const renderItem = ({ item }) => (
        <View style={styles.itemContainer}>
            <TouchableOpacity onPress={() => navigation.navigate('ProductDetailsPage', { id: item?.id, category: 'electronics' })}>
    ...
    return (
        <View style={styles.container}>
            ...
            <View  >
                <Text style={styles.jewellerytext}>Electronics</Text>
            </View>
            <FlatList
                data={data}
