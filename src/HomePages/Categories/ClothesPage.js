...
const ClothesPage = () => {
  ...
  const getAPI = async () => {
    const url = "http://192.168.1.18:3000/Clothes";
  ...
  const renderItem = ({ item }) => (
    <View style={styles.itemContainer}>
      <TouchableOpacity onPress={() => navigation.navigate('ProductDetailsPage', { id: item?.id, category: 'clothes' })}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View  >
        <Text style={styles.jewellerytext}>Clothes</Text>
      </View>
      <FlatList
        data={data}
